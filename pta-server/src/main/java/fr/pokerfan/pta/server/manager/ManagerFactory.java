...
/**
 * Manager factory permettant de récupérer un manager spécifique par rapport à
 * l'id de la requête envoyé par le client.
 * 
...
public final class ManagerFactory {
	...
	private Manager getManagerById(final int idManager) {
		LOGGER
				.info("Récupération du manager spécifique pour la requête d'id : "
						+ idManager);
